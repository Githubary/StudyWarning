...
public class teacherWarningReasonActivity2 extends BaseActivity implements View.OnClickListener{
    ...
    protected int initLayout() {
        return R.layout.activity_teacher_warning_reason2;
    }
    ...
    private void showCheckInPieChart() {
        ...
        yvals.add(new PieEntry(1.2f, "请假"));
        yvals.add(new PieEntry(6.7f, "到课"));
        yvals.add(new PieEntry(2.1f, "缺勤"));
        //设置每份的颜色
    ...
    private void showQuestionPieChart() {
        // 设置每份所占数量
        List<PieEntry> yvals = new ArrayList<>();
        yvals.add(new PieEntry(4.2f, "基本掌握"));
        yvals.add(new PieEntry(3.4f, "掌握一般"));
        yvals.add(new PieEntry(2.4f, "错误较多"));
        //设置每份的颜色
        List<Integer> colors = new ArrayList<>();
        colors.add(Color.parseColor("#4EEE94"));
        colors.add(Color.parseColor("#FFD700"));
    ...
    private void showHomeworkPieChart() {
        // 设置每份所占数量
        List<PieEntry> yvals = new ArrayList<>();
        yvals.add(new PieEntry(4.8f, "正确完成"));
        yvals.add(new PieEntry(3.1f, "未完成"));
