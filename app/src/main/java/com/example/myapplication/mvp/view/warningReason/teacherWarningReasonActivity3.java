...
public class teacherWarningReasonActivity3 extends BaseActivity implements View.OnClickListener{
    ...
    protected int initLayout() {
        return R.layout.activity_teacher_warning_reason3;
    }
    ...
    private void showCheckInPieChart() {
        ...
        yvals.add(new PieEntry(1.8f, "请假"));
        yvals.add(new PieEntry(7.2f, "到课"));
    ...
    private void showQuestionPieChart() {
        // 设置每份所占数量
        List<PieEntry> yvals = new ArrayList<>();
        yvals.add(new PieEntry(5.0f, "基本掌握"));
        yvals.add(new PieEntry(3.2f, "掌握一般"));
        yvals.add(new PieEntry(1.8f, "错误较多"));
        //设置每份的颜色
        List<Integer> colors = new ArrayList<>();
        colors.add(Color.parseColor("#4EEE94"));
        colors.add(Color.parseColor("#FFD700"));
    ...
    private void showHomeworkPieChart() {
        // 设置每份所占数量
        List<PieEntry> yvals = new ArrayList<>();
        yvals.add(new PieEntry(5.2f, "正确完成"));
        yvals.add(new PieEntry(2.1f, "未完成"));
        yvals.add(new PieEntry(2.7f, "掌握一般"));
        //设置每份的颜色
        List<Integer> colors = new ArrayList<>();
        colors.add(Color.parseColor("#4EEE94"));
        colors.add(Color.parseColor("#FFD700"));
