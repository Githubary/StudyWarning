...
public class PieChartManagger {
    ...
    private void initPieChart() {
        ...
        pieChart.setCenterText("考勤"); //设置中间文字
        ...
        //图相对于上下左右的偏移
        pieChart.setExtraOffsets(20, 5, 75, 8);
        //图标的背景色
...
//        设置pieChart图表转动阻力摩擦系数[0,1]
        ...
        legend.setYEntrySpace(5f); //y轴的间距
        legend.setYOffset(5f);  //图例的y偏移量
        legend.setXOffset(45f);  //图例x的偏移量
...
//        显示试图
    ...
    public void  showRingPieChart(List<PieEntry> yvals, List<Integer> colors){
        ...
        pieChart.setHoleRadius(55f);//设置中间洞的大小
